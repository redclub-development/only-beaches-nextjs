...
export const beachMoodsCatalog: BeachMoodItem[] = [
  {
    ...
    description: "Secluded coves the crowds haven't found yet.",
    category: "Scenic",
    beachCount: 184,
  ...
  },
  {
    ...
    slug: "party-beaches",
    title: "Party beaches",
    description: "Where the music never stops and sunsets ignite.",
    category: "Lifestyle",
    beachCount: 96,
  ...
  },
  {
    ...
    description: "Crystal lagoons teeming with marine life.",
    category: "Adventure",
    beachCount: 213,
  ...
  },
  {
    ...
    description: "Golden hour vistas made for two.",
    category: "Relaxation",
    beachCount: 147,
