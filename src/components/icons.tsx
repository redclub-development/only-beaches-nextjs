...
export function IconFire({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M12 23c-3.9-2.4-6-6.5-6-10.5 0-2.5 1-4.8 2.7-6.5.5 3.2 2.1 5.6 4.1 7.2-.3-2.1-.1-4.4 1-6.3C17 9.5 18 12 18 14.5 18 18.5 15.9 22.6 12 23z" />
    </svg>
  );
}

export function IconSurf({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="16"
      ...
      aria-hidden
    >
      <path d="M4 18c2-4 6-6 12-6M4 14c3-3 7-4 12-3" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconPizza({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M12 2L2 22h20L12 2zm0 4.5L18.5 20h-13L12 6.5zM12 11a2 2 0 1 0 0 4 2 2 0 0 0 0-4z" />
    </svg>
  );
}
...
export function IconMountain({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M3 20h18L12 4 3 20zm9-11l3 6H9l3-3z" />
    </svg>
  );
}
...
export function IconBikini({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="16"
      ...
      aria-hidden
    >
      <path d="M6 4c0 2 2 3 6 3s6-1 6-3M6 20c0-2 2-3 6-3s6 1 6 3M8 10l2 4h4l2-4" />
    </svg>
  );
}
